...
> Открыть эту страницу в [https://mrbigvladua.github.io/test/](https://mrbigvladua.github.io/test/)
...
* найдите **https://github.com/mrbigvladua/test** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/mrbigvladua/test/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/mrbigvladua/test** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/mrbigvladua/test/raw/master/.github/makecode/blocks.png)
